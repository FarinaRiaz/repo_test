var oc=oc||{};oc.components=oc.components||{};oc.components['3c36871f1c163f5131d1861a402361f36ccac239']=function(model) {
  ...
  oc.reactComponents['3e1c8c598d43ca0220643b56d59d0786664e3ea0'] = oc.reactComponents['3e1c8c598d43ca0220643b56d59d0786664e3ea0'] || ((function() {
  ...
  const App = () => {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "Hello ,Body of project" });
  };
  var useData$1 = {};
  ...
  if (ssr) {
    externals.push({
      global: ['oc', 'components', '3c36871f1c163f5131d1861a402361f36ccac239'],
  ...
  var templateId = "oc-reactRoot-body-" + count;
  oc.__reactTemplate.count++;
  var ssrCall = 'oc.components["3c36871f1c163f5131d1861a402361f36ccac239"]({ component: { props:' + props + ' } });';

  return '<div id="' + templateId + '" class="oc-reactRoot-body">' + modelHTML + '</div>' +
    '' +
    '<script>' +
    'oc = oc || {};' +
    'oc.cmd = oc.cmd || [];' +
    ...
    '' +
      'oc.requireSeries(' + JSON.stringify(externals) + ', function(){' +
        ...
        (ssr ? ssrCall : '') +
        'oc.components["3c36871f1c163f5131d1861a402361f36ccac239"]({ component: { props:' + props + ' } });' +
        'oc.reactComponents["3e1c8c598d43ca0220643b56d59d0786664e3ea0"](' + props + ', targetNode, ' + !!modelHTML  + ');' +
      '});' +
    '});' +
  '</script>'
};
